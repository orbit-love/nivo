(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@nivo/core'), require('@nivo/colors'), require('@nivo/tooltip'), require('lodash/get'), require('d3-shape'), require('@nivo/legends')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', '@nivo/core', '@nivo/colors', '@nivo/tooltip', 'lodash/get', 'd3-shape', '@nivo/legends'], factory) :
    (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.nivo, global.nivo, global.nivo, global['lodash/get'], global.d3, global.nivo));
}(this, (function (exports, React, core, colors, tooltip, _get, d3Shape, legends) { 'use strict';
