...
import { useTheme, treeMapTilePropType, defsPropTypes, useValueFormatter, treeMapTileFromProp, useMotionConfig, withContainer, useDimensions, bindDefs, SvgWrapper, ResponsiveWrapper, degreesToRadians, getRelativeCursor, isCursorInRect } from '@nivo/core';
import PropTypes from 'prop-types';
import { ordinalColorsPropType, colorPropertyAccessorPropType, inheritedColorPropType, useOrdinalColorScale, useInheritedColor } from '@nivo/colors';
...
var TreeMapNode = function TreeMapNode(_ref) {
  ...
  }), showLabel && React.createElement(animated.text, {
    textAnchor: "middle",
  ...
  }, node.label), showParentLabel && React.createElement(animated.text, {
    dominantBaseline: "central",
    style: _objectSpread2(_objectSpread2({}, theme.labels.text), {}, {
...
var TreeMapNode$1 = memo(TreeMapNode);
...
var TreeMapHtmlNode = function TreeMapHtmlNode(_ref) {
  ...
  return React.createElement(animated.div, {
    ...
    onMouseLeave: node.onMouseLeave,
    onClick: node.onClick
  }), showLabel && React.createElement(animated.span, {
    style: _objectSpread2(_objectSpread2({}, theme.labels.text), {}, {
      position: 'absolute',
      display: 'flex',
      top: -5,
  ...
  }, node.label), showParentLabel && React.createElement(animated.span, {
    style: _objectSpread2(_objectSpread2({}, theme.labels.text), {}, {
      position: 'absolute',
      display: 'flex',
...
var TreeMapHtmlNode$1 = memo(TreeMapHtmlNode);
...
var TreeMapNodeTooltip$1 = memo(TreeMapNodeTooltip);
...
var useTreeMapLayout = function useTreeMapLayout(_ref) {
  ...
  return useMemo(function () {
    var treemap$1 = treemap().size([width, height]).tile(treeMapTileFromProp(tile)).round(true).paddingInner(innerPadding).paddingOuter(outerPadding);
    if (enableParentLabel && !leavesOnly) {
      var parentLabelPadding = parentLabelSize + outerPadding * 2;
      treemap$1["padding".concat(startCase(parentLabelPosition))](parentLabelPadding);
    }
    return treemap$1;
...
var useHierarchy = function useHierarchy(_ref2) {
  ...
  return useMemo(function () {
    return hierarchy(root).sum(getValue);
  }, [root, getValue]);
};
...
var useTreeMap = function useTreeMap(_ref3) {
  ...
  var getParentLabelTextColor = useInheritedColor(parentLabelTextColor, theme);
  var enhancedNodes = useMemo(function () {
...
var useInteractiveTreeMapNodes = function useInteractiveTreeMapNodes(nodes, _ref4) {
  ...
  var showTooltip = useCallback(function (node, event) {
    showTooltipFromEvent(React.createElement(TreeMapNodeTooltip$1, {
      node: node,
      tooltip: tooltip
    }), event, 'left');
...
var TreeMapNodes = function TreeMapNodes(_ref) {
  ...
  var transitions = useTransition(interactiveNodes, function (node) {
    return node.path;
  }, {
...
var TreeMapNodes$1 = memo(TreeMapNodes);
...
var TreeMap = function TreeMap(_ref) {
  ...
  return React.createElement(SvgWrapper, {
    ...
    defs: boundDefs,
    role: role
  }, React.createElement(TreeMapNodes$1, {
    nodes: nodes,
...
var WrappedTreeMap = withContainer(TreeMap);
...
var ResponsiveTreeMap = function ResponsiveTreeMap(props) {
  return React.createElement(ResponsiveWrapper, null, function (_ref) {
    var width = _ref.width,
        height = _ref.height;
    return React.createElement(WrappedTreeMap, Object.assign({
      width: width,
      height: height
    }, props));
  });
...
var WrappedTreeMapHtml = withContainer(TreeMapHtml);
...
var ResponsiveTreeMapHtml = function ResponsiveTreeMapHtml(props) {
  return React.createElement(ResponsiveWrapper, null, function (_ref) {
    var width = _ref.width,
        height = _ref.height;
    return React.createElement(WrappedTreeMapHtml, Object.assign({
      width: width,
      height: height
    }, props));
  });
...
var WrappedTreeMapCanvas = withContainer(TreeMapCanvas);
...
var ResponsiveTreeMapCanvas = function ResponsiveTreeMapCanvas(props) {
  return React.createElement(ResponsiveWrapper, null, function (_ref) {
    var width = _ref.width,
        height = _ref.height;
    return React.createElement(WrappedTreeMapCanvas, Object.assign({
      width: width,
      height: height
    }, props));
  });
...
export { ResponsiveTreeMap, ResponsiveTreeMapCanvas, ResponsiveTreeMapHtml, WrappedTreeMap as TreeMap, WrappedTreeMapCanvas as TreeMapCanvas, TreeMapCanvasDefaultProps, TreeMapCanvasPropTypes, TreeMapDefaultProps, WrappedTreeMapHtml as TreeMapHtml, TreeMapHtmlDefaultProps, TreeMapHtmlPropTypes, TreeMapPropTypes };
