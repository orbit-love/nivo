(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@nivo/core'), require('prop-types'), require('@nivo/colors'), require('react-spring'), require('lodash/get'), require('lodash/omit'), require('lodash/cloneDeep'), require('lodash/startCase'), require('d3-hierarchy'), require('@nivo/tooltip')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@nivo/core', 'prop-types', '@nivo/colors', 'react-spring', 'lodash/get', 'lodash/omit', 'lodash/cloneDeep', 'lodash/startCase', 'd3-hierarchy', '@nivo/tooltip'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.nivo, global.PropTypes, global.nivo, global['react-spring'], global['lodash/get'], global['lodash/omit'], global['lodash/cloneDeep'], global['lodash/startCase'], global.d3, global.nivo));
}(this, (function (exports, React, core, PropTypes, colors, reactSpring, get, omit, cloneDeep, startCase, d3Hierarchy, tooltip) { 'use strict';

  var React__default = 'default' in React ? React['default'] : React;
  PropTypes = PropTypes && Object.prototype.hasOwnProperty.call(PropTypes, 'default') ? PropTypes['default'] : PropTypes;
  get = get && Object.prototype.hasOwnProperty.call(get, 'default') ? get['default'] : get;
  omit = omit && Object.prototype.hasOwnProperty.call(omit, 'default') ? omit['default'] : omit;
  cloneDeep = cloneDeep && Object.prototype.hasOwnProperty.call(cloneDeep, 'default') ? cloneDeep['default'] : cloneDeep;
  startCase = startCase && Object.prototype.hasOwnProperty.call(startCase, 'default') ? startCase['default'] : startCase;
