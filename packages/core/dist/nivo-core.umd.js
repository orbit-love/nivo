(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@nivo/tooltip'), require('prop-types'), require('lodash/merge'), require('lodash/get'), require('lodash/set'), require('d3-interpolate'), require('lodash/isString'), require('react-spring'), require('lodash/last'), require('lodash/isArray'), require('d3-scale'), require('d3-scale-chromatic'), require('lodash/isFunction'), require('lodash/without'), require('d3-shape'), require('d3-hierarchy'), require('d3-format'), require('d3-time-format'), require('recompose/withProps'), require('lodash/isEqual'), require('recompose/compose'), require('recompose/setPropTypes'), require('recompose/defaultProps'), require('recompose/withPropsOnChange'), require('lodash/isPlainObject'), require('lodash/pick')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@nivo/tooltip', 'prop-types', 'lodash/merge', 'lodash/get', 'lodash/set', 'd3-interpolate', 'lodash/isString', 'react-spring', 'lodash/last', 'lodash/isArray', 'd3-scale', 'd3-scale-chromatic', 'lodash/isFunction', 'lodash/without', 'd3-shape', 'd3-hierarchy', 'd3-format', 'd3-time-format', 'recompose/withProps', 'lodash/isEqual', 'recompose/compose', 'recompose/setPropTypes', 'recompose/defaultProps', 'recompose/withPropsOnChange', 'lodash/isPlainObject', 'lodash/pick'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.nivo, global.PropTypes, global['lodash/merge'], global['lodash/get'], global['lodash/set'], global.d3, global['lodash/isString'], global['react-spring'], global['lodash/last'], global['lodash/isArray'], global.d3, global.d3, global['lodash/isFunction'], global['lodash/without'], global.d3, global.d3, global.d3, global.d3, global.RecomposeWithProps, global['lodash/isEqual'], global.RecomposeCompose, global.RecomposeSetPropTypes, global.RecomposeDefaultProps, global.RecomposeWithPropsOnChange, global['lodash/isPlainObject'], global['lodash/pick']));
}(this, (function (exports, React, tooltip, PropTypes, merge, get, set, d3Interpolate, _isString, reactSpring, last, isArray, d3Scale, d3ScaleChromatic, isFunction, without, d3Shape, d3Hierarchy, d3Format, d3TimeFormat, withProps, isEqual, compose, setPropTypes, defaultProps, withPropsOnChange, isPlainObject, pick) { 'use strict';
  ...
  setPropTypes = setPropTypes && Object.prototype.hasOwnProperty.call(setPropTypes, 'default') ? setPropTypes['default'] : setPropTypes;
  ...
  var MotionConfigProvider = function MotionConfigProvider(_ref) {
    ...
    var value = React.useMemo(function () {
      var reactSpringConfig = _isString(config) ? reactSpring.config[config] : config;
      return {
        animate: animate,
        springConfig: {
          stiffness: stiffness,
  ...
  var motionPropTypes = {
    ...
    motionConfig: PropTypes.oneOfType([PropTypes.oneOf(Object.keys(reactSpring.config)), PropTypes.shape({
  ...
  var Container = function Container(_ref) {
    ...
    var showTooltip = React.useCallback(function (content, event) {
      return showTooltipFromEvent(content, event);
  ...
  var Defs = function Defs(_ref) {
    ...
    return React__default.createElement("defs", null, definitions.map(function (_ref2) {
      ...
      if (defsMapping[type]) return React__default.createElement(defsMapping[type], _objectSpread2({
        key: def.id
      }, def));
      return null;
    }));
  ...
  var CartesianMarkers = function CartesianMarkers(_ref) {
    ...
    return markers.map(function (marker, i) {
      return React__default.createElement(CartesianMarkersItem$1, Object.assign({
        key: i
      }, marker, {
        width: width,
        height: height,
  ...
  var withHierarchy = (function () {
    ...
    return compose(defaultProps(_defineProperty({}, valueKey, valueDefault)), setPropTypes((_setPropTypes = {}, _defineProperty(_setPropTypes, srcKey, PropTypes.object.isRequired), _defineProperty(_setPropTypes, valueKey, PropTypes.oneOfType([PropTypes.string, PropTypes.func]).isRequired), _setPropTypes)), withPropsOnChange([srcKey, valueKey], function (props) {
      return _defineProperty({}, destKey, d3Hierarchy.hierarchy(props[srcKey]).sum(getAccessorFor(props[valueKey])));
    }));
  });
