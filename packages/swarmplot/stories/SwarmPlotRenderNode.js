...
import { generateSwarmPlotData } from '@orbit-nivo/generators'
...
const SwarmPlotRenderNode = () => {
    ...
    return (
        <SwarmPlot
            ...
            axisLeft={null}
            axisBottom={{
                legend: `custom node rendering with donut charts using usePie() React hook from @orbit-nivo/pie package`,
