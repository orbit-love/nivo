...
import { Axis } from '@orbit-nivo/axes'
// @ts-ignore
import { getColorScale, useMotionConfig, useTheme } from '@orbit-nivo/core'
import { BasicTooltip, useTooltip } from '@orbit-nivo/tooltip'
