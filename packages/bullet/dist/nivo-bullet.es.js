...
var BulletMarkers = function BulletMarkers(_ref2) {
  ...
  var transitions = useTransition(markers.map(function (marker) {
  ...
  return React.createElement(React.Fragment, null, transitions.map(function (_ref5) {
...
var BulletRects = function BulletRects(_ref) {
  ...
  var transitions = useTransition(rects, rects.map(function (rect) {
