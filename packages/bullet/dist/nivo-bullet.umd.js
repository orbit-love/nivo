(function (global, factory) {
  ...
  var BulletRectsItem = function BulletRectsItem(_ref) {
    ...
    return React__default.createElement(reactSpring.animated.rect, {
      x: x,
      y: y,
      width: width.interpolate(function (value) {
        return Math.max(value, 0);
      }),
      height: height.interpolate(function (value) {
        return Math.max(value, 0);
      }),
      fill: color,
      onMouseMove: function onMouseMove(event) {
  ...
  var BulletMarkers = function BulletMarkers(_ref2) {
    ...
    var transitions = reactSpring.useTransition(markers.map(function (marker) {
    ...
    return React__default.createElement(React__default.Fragment, null, transitions.map(function (_ref5) {
      var _ref5$item = _ref5.item,
          position = _ref5$item.position,
          marker = _objectWithoutProperties(_ref5$item, ["position"]),
          props = _ref5.props,
          key = _ref5.key;
  ...
  var BulletRects = function BulletRects(_ref) {
    ...
    var transform = (_animatedProps$measur = animatedProps === null || animatedProps === void 0 ? void 0 : animatedProps.measuresY.interpolate(getTransform)) !== null && _animatedProps$measur !== void 0 ? _animatedProps$measur : getTransform(y);

    var _useMotionConfig = core.useMotionConfig(),
        animate = _useMotionConfig.animate,
        springConfig = _useMotionConfig.config;

    var transitions = reactSpring.useTransition(rects, rects.map(function (rect) {
    ...
    return React__default.createElement(reactSpring.animated.g, {
      ...
      return React__default.createElement(component, {
        ...
        x: props.x.getValue(),
        y: props.y.getValue(),
        width: props.width.interpolate(function (value) {
          return Math.max(value, 0);
        }).getValue(),
        height: props.height.interpolate(function (value) {
          return Math.max(value, 0);
        }).getValue(),
