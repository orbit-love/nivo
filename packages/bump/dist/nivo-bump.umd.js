(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@nivo/core'), require('@nivo/axes'), require('d3-shape'), require('@nivo/colors'), require('@nivo/tooltip'), require('d3-scale'), require('prop-types'), require('react-spring')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@nivo/core', '@nivo/axes', 'd3-shape', '@nivo/colors', '@nivo/tooltip', 'd3-scale', 'prop-types', 'react-spring'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.nivo, global.nivo, global.d3, global.nivo, global.nivo, global.d3, global.PropTypes, global['react-spring']));
}(this, (function (exports, React, core, axes, d3Shape, colors, tooltip, d3Scale, PropTypes, reactSpring) { 'use strict';
...
//# sourceMappingURL=nivo-bump.umd.js.map
