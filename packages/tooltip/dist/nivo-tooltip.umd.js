(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-spring'), require('@nivo/core'), require('prop-types')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-spring', '@nivo/core', 'prop-types'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global['react-spring'], global.nivo, global.PropTypes));
}(this, (function (exports, React, reactSpring, core, PropTypes) { 'use strict';
